  ...
  <ModalLayout>
    <div>
      ...
      <div class="vuefinder__move-modal__content">
        <p class="vuefinder__move-modal__description">
        ...
        <h4 class="vuefinder__move-modal__target-title">
          {{ t("Target Directory") }}
        </h4>
        <p class="vuefinder__move-modal__target-directory">
          ...
          <span class="vuefinder__move-modal__target-path">{{
            app.modal.data.items.to.path
          }}</span>
        </p>
    ...
    app.emitter.emit("vf-fetch", {
      ...
      onSuccess: () => {
        app.emitter.emit("vf-toast-push", {
          label: t("Files moved.", app.modal.data.items.to.name),
        });
