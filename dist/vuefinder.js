...
function Sr(n, e, s, r) {
  ...
  Le(f, (u) => {
    i(u);
  }), r && Object.keys(r).length > 0 ? i(f.value) : d.value = o("translations") ?? {};
...
const Ys = (n, e) => n.indexOf(e) >= 0, Lt = (n, e) => n.concat(e), ge = (n, e, s) => (!Ut(e) && ns(e) ? Array.prototype.push.apply(n, e) : n.push(e), n), ct = (n) => Array.from(n || []), ss = (n) => Ke(n) ? n : !Ut(n) && ns(n) ? ct(n) : [n], Hn = (n) => !!n && !n.length, Bn = (n) => ct(new Set(n)), Re = (n, e, s) => {
  ...
  const u = function(S) {
    ...
    if (Ye(M) && M >= 0) {
      const L = Be(r) ? r() : r, k = Ye(L) && L >= 0, O = M > 0 ? rn : es, R = M > 0 ? Un : Ws, x = p(S) || S, E = u.bind(0, x);
      let T;
      _(), o && !v ? (E(), v = !0, T = O(() => v = void 0, M)) : (T = O(E, M), k && !d && (d = rn(h, L))), _ = () => R(T), f = i = x;
    } else
      u(S);
  };
  return g.m = h, g;
...
const pa = () => {
  ...
  const { ct: c, rt: d, lt: f, it: i, ut: v, ft: _ } = r || {}, u = dn(() => o && s(!0), {
    _: 33,
    p: 99
  }), [p, h] = ha(n, u, f), g = c || [], y = d || [], S = Lt(g, y), M = (L, k) => {
    if (!Hn(k)) {
      const O = v || lt, R = _ || lt, $ = [], x = [];
      let E = !1, T = !1;
      if (ie(k, (I) => {
        ...
        if (e && (se || !me)) {
          const G = oe && q, z = G && i && Nn(B, i), J = (z ? !O(B, V, N, H) : !oe || G) && !R(I, !!z, n, r);
          ie(P, (ae) => ge($, ae)), ie(ee, (ae) => ge($, ae)), T = T || J;
        }
        !e && me && q && !O(B, V, N, H) && (ge(x, V), E = E || D);
      }), h((I) => Bn($).reduce((V, B) => (ge(V, fo(I, B)), Nn(B, I) ? ge(V, B) : V), [])), e)
        return !L && T && s(!1), [!1];
      if (!Hn(x) || E) {
        const I = [Bn(x), E];
...
const Oo = (n, e, s) => {
  ...
  return () => {
    const d = [], i = mo(`<div class="${ds}"><div class="${Qr}"></div></div>`)[0], v = i.firstChild, _ = (u) => {
      ...
      let h = !1, g = !1;
      if (p) {
        const [y, , S] = c(u.contentRect), M = jn(y);
        g = bo(y, S), h = !g && !M;
      } else
        g = u === !0;
      h || e({
  ...
  let o, c, d, f, i, v;
  const _ = `[${it}]`, u = `[${Qe}]`, p = ["id", "class", "style", "open", "wrap", "cols", "rows"], { vt: h, ht: g, U: y, gt: S, bt: M, L: U, wt: L, yt: k, St: O, Ot: R } = n, $ = (D) => tt(D, "direction") === "rtl", x = {
    $t: !1,
    F: $(h)
  }, E = Xe(), T = Ht(Ao), [I] = Fe({
    i: oo,
    ...
    const D = T && T.V(n, e, x, E, s).W, z = !(L && U) && ls(g, it, sn), Y = !U && k(Kr), J = Y && Ie(S), ae = J && R(), fe = O(Co, z), ce = Y && D && D()[0], Te = fn(y), te = cs(y);
  ...
  return [() => {
    ...
    return () => {
      H && H.disconnect(), D && D(), G && G(), f && f(), z(), Y();
    };
  }, ({ It: D, At: G, Dt: z }) => {
  ...
  const o = "--os-viewport-percent", c = "--os-scroll-percent", d = "--os-scroll-direction", { Z: f } = Xe(), { scrollbars: i } = f(), { slot: v } = i, { vt: _, ht: u, U: p, Mt: h, gt: g, wt: y, L: S } = e, { scrollbars: M } = h ? {} : n, { slot: U } = M || {}, L = [], k = [], O = [], R = Vo([_, u, p], () => S && y ? _ : u, v, U), $ = (K) => {
    if (Dt) {
      let C = null, H = [];
      const q = new Dt({
        source: g,
    ...
    const { Tt: K } = s, C = On(K), H = (q) => (D) => [D.Ut, {
      [d]: q ? "0" : "1"
    }];
    I(k, H(C.x)), I(O, H(C.y)), Dt && (k.forEach(x.x.Rt), O.forEach(x.y.Rt));
  }, P = () => {
    if (S && !y) {
      const { Vt: K, Tt: C } = s, H = On(C), q = Cs(C, Ie(g)), D = (G) => {
    ...
    const C = K ? "x" : "y", q = wt(`${Ue} ${K ? sa : oa}`), D = wt(To), G = wt(us), z = {
      Ut: q,
      Pt: D,
      kt: G
    }, Y = x[C];
    return ge(K ? k : O, z), ge(L, [Oe(q, D), Oe(D, G), Z(xt, q), Y && Y.Rt(z), r(z, V, K)]), z;
  }, oe = Z(ee, !0), se = Z(ee, !1), me = () => (Oe(R, k[0].Ut), Oe(R, O[0].Ut), Z(Re, L));
  return oe(), se(), [{
    Nt: B,
    qt: A,
    Bt: N,
  ...
  const { ht: f, U: i, L: v, gt: _, Kt: u, Ot: p } = e, { Ut: h, Pt: g, kt: y } = o, [S, M] = gt(333), [U, L] = gt(444), k = ($) => {
    ...
    const $ = "pointerup pointercancel lostpointercapture", x = `client${d ? "X" : "Y"}`, E = d ? gn : bn, T = d ? "left" : "top", I = d ? "w" : "h", V = d ? "x" : "y", B = (N, P) => (ee) => {
      const { Vt: oe } = s, se = yt(g)[I] - yt(y)[I], K = P * ee / se * oe[V];
      We(_, {
        [V]: N + K
      });
    }, A = [];
    return ve(g, "pointerdown", (N) => {
      const P = bt(N.target, `.${us}`) === y, ee = P ? y : g, oe = n.scrollbars, se = oe[P ? "dragScroll" : "clickScroll"], { button: me, isPrimary: K, pointerType: C } = N, { pointers: H } = oe;
      if (me === 0 && K && se && (H || []).includes(C)) {
        Re(A), L();
        const D = !P && (N.shiftKey || se === "instant"), G = Z(Dn, y), z = Z(Dn, g), Y = (ue, $e) => (ue || G())[T] - ($e || z())[T], J = Rn(Dn(_)[E]) / yt(_)[I] || 1, ae = B(Ie(_)[V], 1 / J), fe = N[x], ce = G(), Te = z(), te = ce[E], ye = Y(ce, Te) + te / 2, De = fe - Te[T], xe = P ? 0 : De - ye, Se = (ue) => {
          Re(pe), ee.releasePointerCapture(ue.pointerId);
        }, be = P || D, we = p(), pe = [ve(u, $, Se), ve(u, "selectstart", (ue) => Gn(ue), {
          H: !1
  ...
  const h = ["mouse", "pen"], g = (C) => h.includes(C.pointerType), [y, S] = gt(), [M, U] = gt(100), [L, k] = gt(100), [O, R] = gt(() => p), [$, x] = ka(n, o, r, xa(e, o, r, (C) => g(C) && oe())), { ht: E, Qt: T, wt: I } = o, { jt: V, Nt: B, qt: A, Bt: N, Ft: P } = $, ee = (C, H) => {
    if (R(), C)
      V(Os);
    else {
      const q = Z(V, Os, !0);
    ...
    g(C) && (d = i, i && ee(!0));
  }, K = [R, U, k, S, () => u(), ve(E, "pointerover", me, {
    A: !0
  ...
  return [() => Z(Re, ge(K, x())), ({ It: C, Dt: H, Zt: q, tn: D }) => {
    ...
    if (p = Bt, $n && (Me && Cn ? (se(!1), u(), L(() => {
      u = ve(T, "scroll", Z(se, !0), {
        A: !0
      });
    })) : se(!0)), xe && V(ta, zt), be && (V(_), V(Se, !0), _ = Se), Et && !Me && se(!0), $e && (f = ue === "move", i = ue === "leave", v = ue === "never", ee(v, !0)), Pt && V(ia, Nt), Tt && V(la, !!ut), En) {
  ...
  const e = Xe(), { Z: s, P: r } = e, { elements: o } = s(), { padding: c, viewport: d, content: f } = o, i = cn(n), v = i ? {} : n, { elements: _ } = v, { padding: u, viewport: p, content: h } = _ || {}, g = i ? n : v.target, y = vo(g), S = g.ownerDocument, M = S.documentElement, U = () => S.defaultView || Ve, L = Z(wa, [g]), k = Z(Vo, [g]), O = Z(wt, ""), R = Z(L, O, d), $ = Z(k, O, f), x = (te) => {
    const ye = yt(te), De = fn(te), xe = tt(te, no), Se = tt(te, so);
    return De.w - ye.w > 0 && !St(xe) || De.h - ye.h > 0 && !St(Se);
  }, E = R(p), T = E === g, I = T && y, V = !T && $(h), B = !T && E === V, A = I ? M : E, N = I ? A : g, P = !T && k(O, c, u), ee = !B && V, oe = [ee, A, P, N].map((te) => cn(te) && !Vt(te) && te), se = (te) => te && Ys(oe, te), me = !se(A) && x(A) ? A : g, K = I ? M : A, H = {
    vt: g,
    ht: N,
    U: A,
    ln: P,
    ...
    ze(D, [it, Ln]), ze(q, Ln), y && ze(M, [Ln, it]);
  }];
  ...
  return [H, () => {
    ...
    return Je(D, it, T ? "" : Gr), Je(G, Kn, ""), Je(z, Qe, ""), Je(Y, As, ""), T || (Je(z, Se, be || "-1"), y && Je(M, Ts, "")), Oe(fe, ae), Oe(D, G), Oe(G || D, !T && z), Oe(z, Y), ge(J, [we, () => {
  ...
  return ({ It: f, Zt: i, fn: v, Dt: _ }) => {
    let [u, p] = d(_);
    const { P: h } = Xe(), { dt: g, Ht: y, Ct: S } = i || {}, { F: M } = v, [U, L] = f("paddingAbsolute");
    (g || p || (_ || y)) && ([u, p] = c(_));
    const O = !r && (L || S || p);
    if (O) {
      const R = !U || !e && !h, $ = u.r + u.l, x = u.t + u.b, E = {
        [eo]: R && !M ? -$ : 0,
        [to]: R ? -x : 0,
        [Qs]: R && M ? -$ : 0,
        top: R ? -u.t : 0,
        right: R ? M ? -u.r : "auto" : 0,
        left: R ? M ? "auto" : -u.l : 0,
        [gn]: R && `calc(100% + ${$}px)`
      }, T = {
        [Ks]: R ? u.t : 0,
  ...
  const s = Xe(), { ht: r, ln: o, U: c, L: d, Qt: f, gt: i, wt: v, St: _, un: u } = n, { P: p } = s, h = v && d, g = Z(Gs, 0), y = {
    ...
    o: ko()
  }), se = Ht(Ao), me = (C, H) => `${H ? Wr : Yr}${Lr(C)}`, K = (C) => {
    const H = (D) => [at, vt, kt].map((G) => me(G, D)), q = H(!0).concat(H()).join(" ");
    _(q), _(Ne(C).map((D) => me(C[D], D === "x")).join(" "), !0);
  };
  return ({ It: C, Zt: H, fn: q, Dt: D }, { dn: G }) => {
    const { dt: z, Ht: Y, Ct: J, _t: ae, zt: fe } = H || {}, ce = se && se.V(n, e, q, s, C), { Y: Te, W: te, J: ye } = ce || {}, [De, xe] = da(C, s), [Se, be] = C("overflow"), we = St(Se.x), pe = St(Se.y), ue = z || G || Y || J || fe || xe;
    let $e = $(D), Me = E(D), Et = I(D), Bt = A(D);
    if (xe && p && _(Eo, !De), ue) {
      ls(r, it, sn) && L(!0);
      const [hs] = te ? te() : [], [Wt] = $e = R(D), [Yt] = Me = x(D), Kt = go(c), Xt = h && Nr(u()), sr = {
        w: g(Yt.w + Wt.w),
        h: g(Yt.h + Wt.h)
      }, gs = {
  ...
  return [s, (h) => {
    const g = {}, S = u && Ie(d), M = S && i();
    return ie(p, (U) => {
      re(g, U(h, g) || {});
    }), We(d, S), M && M(), f || We(c, 0), g;
  }, o, e, r];
}, Ma = (n, e, s, r, o) => {
  let c = !1;
  const d = Is(e, {}), [f, i, v, _, u] = Aa(n), [p, h, g] = ba(_, v, d, (k) => {
    L({}, k);
  }), [y, S, , M] = Sa(n, e, g, v, _, o), U = (k) => Ne(k).some((O) => !!k[O]), L = (k, O) => {
    if (s())
      return !1;
  ...
  return [() => {
    const { an: k, gt: O, Ot: R } = _, $ = Ie(k), x = [p(), f(), y()], E = R();
    return We(O, $), E(), Z(Re, x);
  }, L, () => ({
    gn: g,
    bn: v
  }), {
  ...
  if (e && !d) {
    ...
    const i = [], v = {}, _ = (T) => {
      ...
      return V ? V(I, !0) : I;
    }, u = re({}, r(), _(e)), [p, h, g] = Yn(), [y, S, M] = Yn(s), U = (T, I) => {
      M(T, I), g(T, I);
    }, [L, k, O, R, $] = Ma(n, u, () => f, ({ vn: T, Dt: I }, { Zt: V, tn: B }) => {
      ...
      Oa(c), Re(i), f = !0, U("destroyed", [E, T]), h(), S();
    }, E = {
      options(T, I) {
        if (T) {
          const V = I ? r() : {}, B = Mo(u, re(V, _(T)));
          os(B) || (re(u, B), k({
            vn: B
          }));
        }
      ...
      state() {
        const { gn: T, bn: I } = O(), { F: V } = T, { Lt: B, Vt: A, k: N, rn: P, ln: ee, _n: oe, Tt: se } = I;
        return re({}, {
          overflowEdge: B,
          overflowAmount: A,
          overflowStyle: N,
    ...
    return ge(i, [$]), Da(c, E), $o(xo, Pe, [E, p, v]), ya(R.wn.wt, !o && n.cancel) ? (x(!0), E) : (ge(i, L()), U("initialized", [E]), E.update(), E);
  }
  return d;
};
Pe.plugin = (n) => {
...
function La() {
  ...
  function g() {
    ...
    }), n.subscribe("DS:start:pre", ({ items: O, event: R, isDragging: $ }) => {
      if ($)
  ...
  const y = () => _t(() => {
    ...
    v.value = O, n.subscribe("DS:end", ({ items: R, event: $, isDragging: x }) => {
      o.value = R.map((E) => JSON.parse(E.dataset.item)), O(R.map((E) => JSON.parse(E.dataset.item)));
    });
  }, L = () => {
  ...
  return Ee(() => {
    Pe(p.value, {
      ...
      scroll: (O, R) => {
        const { scrollOffsetElement: $ } = O.elements();
        e.value.scrollTo({
          top: $.scrollTop,
          left: 0
        });
      }
    }), g(), L(), h.value = new ResizeObserver(L), h.value.observe(e.value), e.value.addEventListener("scroll", k), n.subscribe("DS:scroll", ({ isDragging: O }) => O || k());
  }), Qn(() => {
...
function Va(n, e) {
  ...
  function g(U, L) {
    return U.length > L ? [U.slice(-L), U.slice(0, -L)] : [U, []];
  }
  function y(U = null) {
    f.value = U ?? !f.value;
  }
                    ...
                    l("div", $l, [
                      he(l("select", {
                        ...
                        l("optgroup", {
                          ...
                          (m(!0), b(ke, null, Ce(M.value, (k, O) => (m(), b("option", { value: O }, w(k), 9, El))), 256))
                        ], 8, Cl)
                      ], 544), [
                        [bs, a(e).theme.value]
                      ]),
...
const Bo = { render: ki }, xi = { class: "vuefinder__upload-modal__content" }, Si = {
  ...
  key: 1,
  class: "pointer-events-none"
}, Ci = ["disabled"], Ei = { class: "vuefinder__upload-modal__file-list vf-scrollbar" }, Ti = ["textContent"], Ai = { class: "vuefinder__upload-modal__file-info" }, Mi = { class: "vuefinder__upload-modal__file-name hidden md:block" }, Di = { class: "vuefinder__upload-modal__file-name md:hidden" }, Oi = {
  key: 0,
  class: "ml-auto"
  ...
  setup(n) {
    ...
    let S;
    function M(V) {
      return p.value.findIndex((B) => B.id === V);
    }
    function U(V, B = null) {
    ...
    function R() {
      if (!g.value) {
        if (!p.value.filter((V) => V.status !== o.DONE).length) {
    ...
    function $() {
      S.cancelAll({ reason: "user" }), p.value.forEach((V) => {
        V.status !== o.DONE && (V.status = o.CANCELED, V.statusName = s("Canceled"));
      }), g.value = !1;
    }
    function x(V) {
      g.value || (S.removeFile(V.id, "removed-by-user"), p.value.splice(M(V.id), 1));
    }
    function E(V) {
      g.value || (S.cancelAll({ reason: "user" }), p.value.splice(0));
    }
    function T() {
      e.modal.close();
    }
    ...
    return Ee(async () => {
      S = new pr({
        ...
        onBeforeFileAdded(A, N) {
          if (N[A.id] != null) {
            const ee = M(A.id);
            p.value[ee].status === o.PENDING && (h.value = S.i18n("noDuplicates", { fileName: A.name })), p.value = p.value.filter((oe) => oe.id !== A.id);
          }
          return p.value.push({
            id: A.id,
            name: A.name,
        ...
        const P = p.value[M(A.id)];
        x(P), h.value = N.message;
      }), S.on("upload", () => {
        const A = I();
        S.setMeta({ ...A.body });
        const N = S.getPlugin("XHRUpload");
        N.opts.method = A.method, N.opts.endpoint = A.url + "?" + new URLSearchParams(A.params), N.opts.headers = A.headers, delete A.headers["Content-Type"], g.value = !0, p.value.forEach((P) => {
        ...
        p.value[M(A.id)].percent = `${P}%`;
      }), S.on("upload-success", (A) => {
        const N = p.value[M(A.id)];
        ...
        h.value = A.message, g.value = !1, e.emitter.emit("vf-fetch", {
          params: {
            q: "index",
            adapter: e.fs.adapter,
            path: e.fs.data.dirname
        ...
        i.value.click();
      }), u.value.addEventListener("dragover", (A) => {
        A.preventDefault(), y.value = !0;
      }), u.value.addEventListener("dragleave", (A) => {
      ...
      u.value.addEventListener("drop", (A) => {
        A.preventDefault(), y.value = !1;
        const N = /^[/\\](.+)/;
      ...
      f.value.addEventListener("change", B), i.value.addEventListener("change", B);
    }), Ps(() => {
      ...
      default: ne(() => [
        l("div", null, [
          ...
          l("div", xi, [
            ...
            l("div", Ei, [
              (m(!0), b(ke, null, Ce(p.value, (A) => (m(), b("div", {
                ...
                l("div", Ai, [
                  ...
                  l("div", {
                    ...
                    Q(w(A.statusName) + " ", 1),
                    A.status === c.value.QUEUE_ENTRY_STATUS.UPLOADING ? (m(), b("b", Oi, w(A.percent), 1)) : j("", !0)
                  ], 2)
                ]),
                l("button", {
                  type: "button",
              ...
              p.value.length ? j("", !0) : (m(), b("div", Vi, w(a(s)("No files selected!")), 1))
            ]),
            h.value.length ? (m(), X(st, {
              key: 0,
              onHidden: B[1] || (B[1] = (A) => h.value = ""),
              error: ""
            }, {
              default: ne(() => [
                Q(w(h.value), 1)
    ...
    return (f, i) => (m(), X(nt, null, {
      ...
      default: ne(() => [
        l("div", null, [
          ...
          l("div", Hi, [
            l("div", Bi, [
              (m(!0), b(ke, null, Ce(c.value, (v) => (m(), b("p", Ni, [
                v.type === "dir" ? (m(), b("svg", Pi, i[2] || (i[2] = [
                  l("path", {
                    "stroke-linecap": "round",
                    "stroke-linejoin": "round",
                    d: "M3 7v10a2 2 0 002 2h14a2 2 0 002-2V9a2 2 0 00-2-2h-6l-2-2H5a2 2 0 00-2 2z"
      ...
      default: ne(() => [
        l("div", null, [
          ...
          l("div", Yi, [
            l("div", Ki, [
              l("div", Xi, [
                (m(!0), b(ke, null, Ce(c.value, (v) => (m(), b("p", Zi, [
...
const mc = { render: _c }, pc = { class: "vuefinder__toolbar" }, hc = {
  ...
  setup(n) {
    ...
    return (i, v) => (m(), b("div", pc, [
      c.value.length ? (m(), b("div", Sc, [
        l("div", $c, [
        ...
        a(e).features.includes(a(_e).UPLOAD) ? (m(), b("div", {
          ...
          class: "mx-1.5",
          title: a(r)("Upload"),
          onClick: v[1] || (v[1] = (_) => a(e).modal.open(Ii, { items: a(o).getSelected() }))
        }, [
          W(a(Bo))
        ], 8, bc)) : j("", !0),
      ...
      l("div", Ec, [
        a(e).features.includes(a(_e).FULL_SCREEN) ? (m(), b("div", {
          ...
          a(e).fullScreen ? (m(), X(a(cc), { key: 0 })) : (m(), X(a(ac), { key: 1 }))
        ], 8, Tc)) : j("", !0),
        l("div", {
          class: "mx-1.5",
...
const Vc = { render: Lc }, Fc = { class: "vuefinder__move-modal__content" }, Ic = { class: "vuefinder__move-modal__description" }, Rc = { class: "vuefinder__move-modal__files vf-scrollbar" }, Uc = { class: "vuefinder__move-modal__file" }, Hc = {
  key: 0,
...
const _d = { render: vd }, md = { class: "vuefinder__breadcrumb__container" }, pd = ["title"], hd = ["title"], gd = ["title"], bd = { class: "vuefinder__breadcrumb__list" }, wd = {
  ...
  setup(n) {
    ...
    const v = ($, x = null) => {
      $.preventDefault(), r.isDraggingRef.value = !1, p($), x ?? (x = e.fs.hiddenBreadcrumbs.length - 1);
      ...
      $.preventDefault(), r.isDraggingRef.value = !1, p($), x ?? (x = e.fs.breadcrumbs.length - 2);
      let E = JSON.parse($.dataTransfer.getData("items"));
      if (E.find((T) => T.storage !== e.fs.adapter)) {
        alert("Moving items between different storages is not supported yet.");
        return;
    ...
    return ($, x) => (m(), b("div", md, [
      l("span", {
        ...
        W(a(Zc), {
          onDragover: x[0] || (x[0] = (E) => u(E)),
          onDragleave: x[1] || (x[1] = (E) => p(E)),
      ...
      he(l("div", {
        ...
        l("div", null, [
          W(a(sd), {
            onDragover: x[4] || (x[4] = (E) => u(E)),
            onDragleave: x[5] || (x[5] = (E) => p(E)),
        ...
        l("div", bd, [
          a(e).fs.hiddenBreadcrumbs.length ? he((m(), b("div", wd, [
...
const Rd = { render: Id }, en = {
  ...
  setup(n) {
    return (e, s) => (m(), b("div", null, [
      n.direction === "asc" ? (m(), X(a(Vd), { key: 0 })) : j("", !0),
...
const zd = { render: qd }, jd = { class: "vuefinder__drag-item__container" }, Gd = { class: "vuefinder__drag-item__count" }, Wd = {
  ...
  setup(n, { emit: e }) {
    ...
    return (h, g) => (m(), b("div", Yd, [
      l("div", Kd, [
        l("div", {
          class: "vuefinder__text-preview__title",
          id: "modal-title",
          title: a(v).modal.data.item.path
        }, w(a(v).modal.data.item.basename), 9, Xd),
        l("div", Zd, [
          d.value ? (m(), b("button", {
            key: 0,
            onClick: p,
    ...
    return c || (r.value = !0), (d, f) => (m(), X(nt, null, {
      ...
      default: ne(() => [
        ...
        l("div", Du, [
          ...
          l("div", null, [
            l("span", Lu, w(a(s)("Last Modified")) + ": ", 1),
            Q(" " + w(a(jo)(a(e).modal.data.item.last_modified)), 1)
          ])
        ]),
        a(e).features.includes(a(_e).DOWNLOAD) ? (m(), b("div", Vu, [
...
const Wo = { render: Ru }, Uu = ["data-type", "data-item", "data-index"], In = {
  ...
  setup(n) {
    const e = le("ServiceContainer"), s = e.dragSelect, r = n, o = (h) => {
      ...
      mounted(h, g, y, S) {
        y.props.draggable && (h.addEventListener("dragstart", (M) => d(M, g.value)), h.addEventListener("dragover", (M) => i(M, g.value)), h.addEventListener("drop", (M) => f(M, g.value)));
      },
  ...
  setup(n) {
    ...
    const i = $t({ active: !1, column: "", order: "" }), v = (u = !0) => {
      ...
      return i.active && (p = p.slice().sort((S, M) => y(S[h], M[h]) * g)), p;
    }, _ = (u) => {
    ...
    return Ee(() => {
      ...
      a(e).view === "list" || c.value.length ? (m(), b("div", Bu, [
        l("div", {
      ...
      l("div", {
        ...
        a(e).loadingIndicator === "linear" && a(e).fs.loading ? (m(), b("div", Pu)) : j("", !0),
          ...
          default: ne(() => [
            l("div", Wu, [
              l("div", Yu, [
                ...
                l("span", Ku, w(h.basename), 1)
              ]),
              l("div", Xu, w(h.file_size ? a(e).filesize(h.file_size) : ""), 1),
              l("div", Zu, w(a(jo)(h.last_modified)), 1)
            ])
          ]),
          _: 2
          ...
          default: ne(() => [
            l("div", null, [
              l("div", Ju, [
                ...
                !((h.mime_type ?? "").startsWith("image") && a(e).showThumbnails) && h.type !== "dir" ? (m(), b("div", ef, w(r(h.extension)), 1)) : j("", !0)
              ]),
              l("span", tf, w(a(Zn)(h.basename)), 1)
            ])
          ]),
          _: 2
        }, 1032, ["item", "index", "dragImage"]))), 256)) : j("", !0)
  ...
  setup(n) {
    ...
    const i = (v) => {
      ...
      c.active = !0, _t(() => {
        ...
        h = p.right - v.pageX + window.scrollX < M ? h - M : h, g = p.bottom - v.pageY + window.scrollY < S ? g - S : g, c.positions = {
          left: h + "px",
          top: g + "px"
        };
      });
...
const Yo = { render: lf }, cf = { class: "vuefinder__status-bar__wrapper" }, df = { class: "vuefinder__status-bar__space" }, uf = { class: "vuefinder__status-bar__space-container" }, ff = { class: "vuefinder__status-bar__space-icon" }, vf = { class: "vuefinder__status-bar__space-text" }, _f = {
  ...
  setup(n) {
    ...
    return (_, u) => (m(), b("div", cf, [
      l("div", df, [
        l("div", uf, [
          l("span", ff, [
            W(a(Yo))
          ]),
          l("span", vf, w(v.value), 1)
        ])
      ]),
      ...
      l("div", {
        ...
        l("div", {
          ...
          l("div", If, [
            ...
            d.value ? (m(), b("ul", Hf, [
              (m(!0), b(ke, null, Ce(a(e).pinnedFolders, (p) => (m(), b("li", Bf, [
                l("div", {
              ...
              a(e).pinnedFolders.length ? j("", !0) : (m(), b("li", zf, [
                l("div", jf, w(a(s)("No folders pinned")), 1)
              ]))
            ])) : j("", !0)
          ]),
          (m(!0), b(ke, null, Ce(a(e).fs.data.storages, (p) => (m(), b("div", Gf, [
            W(Of, { storage: p }, null, 8, ["storage"])
          ]))), 256))
        ], 512),
        l("div", {
          onMousedown: i,
  ...
  setup(n, { emit: e }) {
    ...
    o.emitter.on("vf-fetch-abort", () => {
      ...
      ({
        ...
        const S = v.signal;
        if (u.q === "download") {
          const M = r.request.baseUrl, U = u.m || "POST", L = new URLSearchParams(u).toString(), k = `${M}?${L}`;
          fetch(k, {
            method: U,
            ...
            return O.blob().then((x) => ({ blob: x, filename: $ }));
          }).then(({ blob: O, filename: R }) => {
            const $ = window.URL.createObjectURL(O), x = document.createElement("a");
        ...
        o.requester.send({
          ...
          o.fs.adapter = M.adapter, o.persist && (o.fs.path = M.dirname, c("path", o.fs.path)), y || o.modal.close(), i(M), h && h(M);
        }).catch((M) => {
