...
function $r(t, e, n, o) {
  const { getStore: s, setStore: i } = t, c = O({}), u = O(s("locale", e)), l = (f, m = e) => {
    Sr(f, o).then((_) => {
      c.value = _, i("locale", f), u.value = f, i("translations", _), Object.values(o).length > 1 && (n.emit("vf-toast-push", { label: "The language is set to " + f }), n.emit("vf-language-saved"));
    }).catch((_) => {
...
const Ve = (t, e) => {
  ...
  let i = n, c;
  const u = (p, f) => {
    const m = i, _ = p, h = f || (o ? !o(m, _) : m !== _);
    return (h || s) && (i = _, c = m), [i, h, c];
  };
  return [e ? (p) => u(e(i, c), p) : u, (p) => [i, !!p, c]];
...
const Ws = (t, e) => t.indexOf(e) >= 0, Vt = (t, e) => t.concat(e), he = (t, e, n) => (!Ht(e) && ts(e) ? Array.prototype.push.apply(t, e) : t.push(e), t), ct = (t) => Array.from(t || []), ns = (t) => Ke(t) ? t : !Ht(t) && ts(t) ? ct(t) : [t], Rn = (t) => !!t && !t.length, Bn = (t) => ct(new Set(t)), Ie = (t, e, n) => {
  ...
  let c, u, l, d, p = lt;
  const f = function(k) {
    p(), Hn(c), d = c = u = void 0, p = lt, t.apply(this, k);
  }, m = (w) => i && u ? i(u, w) : w, _ = () => {
    p !== lt && f(m(l) || l);
  }, h = function() {
    const k = ct(arguments), M = Re(n) ? n() : n;
    if (We(M) && M >= 0) {
      const L = Re(o) ? o() : o, y = We(L) && L >= 0, V = M > 0 ? on : Jn, H = M > 0 ? Hn : Gs, T = m(k) || k, $ = f.bind(0, T);
      let C;
      p(), s && !d ? ($(), d = !0, C = V(() => d = void 0, M)) : (C = V($, M), y && !c && (c = on(_, L))), p = () => H(C), u = l = T;
    } else
      f(k);
  };
  return h.m = _, h;
...
const xs = (t, e, n) => {
  ...
  return X(Ie, _t(e).map((d) => {
    ...
    return t && t.addEventListener(d, p, l), X(Ss, t, d, p, c);
  }));
  ...
  const { D: n, M: o } = t, { w: s, h: i } = e, c = (f, m, _) => {
    let h = bs(f) * _, w = bs(m) * _;
    if (h === w) {
      const k = sn(f), M = sn(m);
      w = k > M ? 0 : w, h = k < M ? 0 : h;
    }
    return h = h === w ? 0 : h, [h + 0, w + 0];
  }, [u, l] = c(n.x, o.x, s), [d, p] = c(n.y, o.y, i);
  return {
    D: {
      x: u,
      y: d
  ...
  const n = (s, i, c, u) => {
    const l = s === at ? ft : s.replace(`${at}-`, ""), d = xt(s), p = xt(c);
    return !i && !u ? ft : d && p ? at : d ? i && u ? l : i ? at : ft : i ? l : p && u ? at : ft;
  }, o = {
    x: n(e.x, t.x, e.y, t.y),
    y: n(e.y, t.y, e.x, t.x)
  };
...
const ha = () => {
  ...
  const s = n ? /* @__PURE__ */ new WeakMap() : !1, i = () => {
    ...
    if (s && n) {
      const l = n.map((d) => {
        const [p, f] = d || [];
        return [f && p ? (u || uo)(p, t) : [], f];
      });
      ie(l, (d) => ie(d[0], (p) => {
        const f = d[1], m = s.get(p) || [];
        if (t.contains(p) && f) {
          const h = ve(p, f, (w) => {
            o ? (h(), s.delete(p)) : e(w);
          });
  ...
  let s = !1;
  const { ct: i, rt: c, lt: u, it: l, ut: d, ft: p } = o || {}, f = cn(() => s && n(!0), {
    _: 33,
    p: 99
  }), [m, _] = ga(t, f, u), h = i || [], w = c || [], k = Vt(h, w), M = (L, y) => {
    if (!Rn(y)) {
      const V = d || lt, H = p || lt, E = [], T = [];
      let $ = !1, C = !1;
      if (ie(y, (F) => {
        const { attributeName: D, target: R, type: x, oldValue: U, addedNodes: P, removedNodes: ee } = F, se = x === "attributes", ne = x === "childList", me = t === R, Y = se && D, S = Y && os(R, D || ""), B = Ht(S) ? S : null, q = Y && U !== B, A = Ws(w, D) && q;
        if (e && (ne || !me)) {
          const G = se && q, z = G && l && Un(R, l), Q = (z ? !V(R, D, U, B) : !se || G) && !H(F, !!z, t, o);
          ie(P, (ae) => he(E, ae)), ie(ee, (ae) => he(E, ae)), C = C || Q;
        }
        !e && me && q && !V(R, D, U, B) && (he(T, D), $ = $ || A);
      }), _((F) => Bn(E).reduce((D, R) => (he(D, uo(F, R)), Un(R, F) ? he(D, R) : D), [])), e)
        return !L && C && n(!1), [!1];
      if (!Rn(T) || $) {
        const F = [Bn(T), $];
...
const Do = (t, e, n) => {
  ...
  return () => {
    const c = [], l = _o(`<div class="${cs}"><div class="${ea}"></div></div>`)[0], d = l.firstChild, p = (f) => {
      const m = f instanceof ResizeObserverEntry;
      let _ = !1, h = !1;
      if (m) {
        const [w, , k] = i(f.contentRect), M = zn(w);
        h = go(w, k), _ = !h && !M;
      } else
        h = f === !0;
      _ || e({
    ...
    if (pt) {
      ...
      const f = cn(p, {
        _: 0,
        p: 0
      }), m = (h) => f(h.pop()), _ = new pt(m);
      if (_.observe(ut ? t : d), he(c, [() => _.disconnect(), !ut && De(t, l)]), ut) {
        const h = new pt(m);
        h.observe(t, {
          box: "border-box"
        }), he(c, () => h.disconnect());
  ...
  let s, i, c, u, l, d;
  const p = `[${it}]`, f = `[${et}]`, m = ["id", "class", "style", "open", "wrap", "cols", "rows"], { vt: _, ht: h, U: w, gt: k, bt: M, L: I, wt: L, yt: y, St: V, Ot: H } = t, E = (A) => nt(A, "direction") === "rtl", T = {
    $t: !1,
    F: E(_)
  }, $ = Ye(), C = Rt(To), [F] = Ve({
    i: so,
    ...
    const A = C && C.V(t, e, T, $, n).W, z = !(L && I) && as(h, it, nn), W = !I && y(Xr), Q = W && Fe(k), ae = Q && H(), fe = V($o, z), ce = W && A && A()[0], Ee = un(w), te = is(w);
    return ce && ce(), Ge(k, Q), ae && ae(), z && fe(), {
      w: Ee.w + te.w,
      h: Ee.h + te.h
    };
  }), D = cn(o, {
  ...
  return [() => {
    ...
    if (Me) {
      ...
      const [ge, be] = Is(M || w, !0, P, {
        ...
        ft: (pe, de) => {
          ...
          return (!de && Ae && !I ? Hr(Se, p, f) : !1) || !!gt(Se, `.${He}`) || !!xe(pe);
        }
      });
      u = ge(), c = be;
    }
    ...
    if (ke) {
      ...
      ge && oe(W, ee(ge[0], ge[1], ke)), be && oe(W, x(be[0], ke)), pe && oe(W, P(pe[0], ke));
    }
    return R(W), W;
  }, T];
  ...
  const { nativeScrollbarsOverlaid: n, body: o } = e || {}, { T: s, P: i, Z: c } = Ye(), { nativeScrollbarsOverlaid: u, body: l } = c().cancel, d = n ?? u, p = es(o) ? l : o, f = (s.x || s.y) && d, m = t && (_n(p) ? !i : p);
  return !!f || !!m;
}, xa = (t, e, n, o) => {
  const s = "--os-viewport-percent", i = "--os-scroll-percent", c = "--os-scroll-direction", { Z: u } = Ye(), { scrollbars: l } = u(), { slot: d } = l, { vt: p, ht: f, U: m, Mt: _, gt: h, wt: w, L: k } = e, { scrollbars: M } = _ ? {} : t, { slot: I } = M || {}, L = [], y = [], V = [], H = Lo([p, f, m], () => k && w ? p : f, d, I), E = (Y) => {
    if (Ot) {
      let S = null, B = [];
      const q = new Ot({
        source: h,
  ...
  const { ht: u, U: l, L: d, gt: p, Kt: f, Ot: m } = e, { Ut: _, Pt: h, kt: w } = s, [k, M] = ht(333), [I, L] = ht(444), y = (E) => {
    Re(p.scrollBy) && p.scrollBy({
      behavior: "smooth",
      left: E.x,
      top: E.y
    });
    ...
    return ve(h, "pointerdown", (U) => {
      ...
      if (me === 0 && Y && ne && (B || []).includes(S)) {
        Ie(x), L();
        const A = !P && (U.shiftKey || ne === "instant"), G = X(Mn, w), z = X(Mn, h), W = (de, Se) => (de || G())[C] - (Se || z())[C], Q = In(Mn(p)[$]) / wt(p)[F] || 1, ae = R(Fe(p)[D], 1 / Q), fe = U[T], ce = G(), Ee = z(), te = ce[$], we = W(ce, Ee) + te / 2, Me = fe - Ee[C], ke = P ? 0 : Me - we, xe = (de) => {
          ...
          (sn(Ae.x) > 3 || sn(Ae.y) > 3) && (m(), Ge(p, de), y(Ae), I(be));
        })];
  ...
  let H = !0;
  return X(Ie, [ve(w, "pointermove pointerleave", o), ve(_, "pointerenter", () => {
    i(As, !0);
    ...
    H: !1,
    I: !0
  }), ve(_, "pointerdown", X(ve, f, "click", wo, {
    A: !0,
    I: !0,
    H: !1
  }), {
  ...
  let c, u, l, d, p, f = lt, m = 0;
  const _ = ["mouse", "pen"], h = (S) => _.includes(S.pointerType), [w, k] = ht(), [M, I] = ht(100), [L, y] = ht(100), [V, H] = ht(() => m), [E, T] = xa(t, s, o, Sa(e, s, o, (S) => h(S) && se())), { ht: $, Qt: C, wt: F } = s, { jt: D, Nt: R, qt: x, Bt: U, Ft: P } = E, ee = (S, B) => {
    if (H(), S)
      D(Ds);
    else {
      const q = X(D, Ds, !0);
  ...
  return [() => X(Ie, he(Y, T())), ({ It: S, Dt: B, Zt: q, tn: A }) => {
    ...
    })) : ne(!0)), ke && D(na, qt), ge && (D(p), D(xe, !0), p = xe), Tt && !Ae && ne(!0), Se && (u = de === "move", l = de === "leave", d = de === "never", ee(d, !0)), Nt && D(ca, Ut), At && D(ia, !!dt), Cn) {
      const ot = zt(Pt.x, te.x, !0), Mt = zt(Pt.y, te.y, !1);
      D(la, !(ot && Mt));
    }
    Pe && (x(), R(), P(), Q && U(), D(Ms, !we.x, !0), D(Ms, !we.y, !1), D(sa, ce && !F));
  }, {}, E];
}, Ca = (t) => {
  const e = Ye(), { Z: n, P: o } = e, { elements: s } = n(), { padding: i, viewport: c, content: u } = s, l = ln(t), d = l ? {} : t, { elements: p } = d, { padding: f, viewport: m, content: _ } = p || {}, h = l ? t : d.target, w = fo(h), k = h.ownerDocument, M = k.documentElement, I = () => k.defaultView || Le, L = X(ya, [h]), y = X(Lo, [h]), V = X(bt, ""), H = X(L, V, c), E = X(y, V, u), T = (te) => {
    const we = wt(te), Me = un(te), ke = nt(te, to), xe = nt(te, no);
    return Me.w - we.w > 0 && !xt(ke) || Me.h - we.h > 0 && !xt(xe);
  }, $ = H(m), C = $ === h, F = C && w, D = !C && E(_), R = !C && $ === D, x = F ? M : $, U = F ? x : h, P = !C && y(V, i, f), ee = !R && D, se = [ee, x, P, U].map((te) => ln(te) && !Ft(te) && te), ne = (te) => te && Ws(se, te), me = !ne(x) && T(x) ? x : h, Y = F ? M : x, B = {
    vt: h,
    ht: U,
    U: x,
    ln: P,
  ...
  return ({ It: u, Zt: l, fn: d, Dt: p }) => {
    let [f, m] = c(p);
    const { P: _ } = Ye(), { dt: h, Ht: w, Ct: k } = l || {}, { F: M } = d, [I, L] = u("paddingAbsolute");
    (h || m || (p || w)) && ([f, m] = i(p));
    const V = !o && (L || k || m);
    if (V) {
      const H = !I || !e && !_, E = f.r + f.l, T = f.t + f.b, $ = {
        [Js]: H && !M ? -E : 0,
        [eo]: H ? -T : 0,
        [Qs]: H && M ? -E : 0,
        top: H ? -f.t : 0,
  ...
  const n = Ye(), { ht: o, ln: s, U: i, L: c, Qt: u, gt: l, wt: d, St: p, un: f } = t, { P: m } = n, _ = d && c, h = X(js, 0), w = {
    display: () => !1,
    direction: (S) => S !== "ltr",
    ...
    L(!0);
    const q = Fe(l), A = p(Qr, !0), G = ve(u, yt, (fe) => {
      const ce = Fe(l);
  ...
  }, [H, E] = Ve(M, X(is, i)), [T, $] = Ve(M, X(un, i)), [C, F] = Ve(M), [D] = Ve(I), [R, x] = Ve(M), [U] = Ve(I), [P] = Ve({
    i: (S, B) => bn(S, B, k),
    o: {}
  }, () => qr(i) ? nt(i, k) : {}), [ee, se] = Ve({
    i: (S, B) => en(S.D, B.D) && en(S.M, B.M),
    o: yo()
  }), ne = Rt(To), me = (S, B) => `${B ? Kr : Yr}${Vr(S)}`, Y = (S) => {
    const B = (A) => [at, ft, yt].map((G) => me(G, A)), q = B(!0).concat(B()).join(" ");
    p(q), p(Ue(S).map((A) => me(S[A], A === "x")).join(" "), !0);
  };
  return ({ It: S, Zt: B, fn: q, Dt: A }, { dn: G }) => {
    ...
    let Se = E(A), Ae = $(A), Tt = F(A), Bt = x(A);
    if (ke && m && p(Co, !Me), de) {
      as(o, it, nn) && L(!0);
      const [ps] = te ? te() : [], [Gt] = Se = H(A), [Wt] = Ae = T(A), Kt = ho(i), Yt = _ && Pr(f()), or = {
        w: h(Wt.w + Gt.w),
        h: h(Wt.h + Gt.h)
      }, hs = {
  ...
  const [e, n, o] = Ca(t), s = {
    ...
    Tt: yo()
  }, { vt: i, gt: c, L: u, Ot: l } = e, { P: d, T: p } = Ye(), f = !d && (p.x || p.y), m = [Ea(e), Ta(e, s), Aa(e, s)];
  return [n, (_) => {
    const h = {}, k = f && Fe(c), M = k && l();
    return ie(m, (I) => {
      oe(h, I(_, h) || {});
    }), Ge(c, k), M && M(), u || Ge(i, 0), h;
  }, s, e, o];
}, Da = (t, e, n, o, s) => {
  let i = !1;
  const c = Fs(e, {}), [u, l, d, p, f] = Ma(t), [m, _, h] = wa(p, d, c, (y) => {
    L({}, y);
  }), [w, k, , M] = $a(t, e, h, d, p, s), I = (y) => Ue(y).some((V) => !!y[V]), L = (y, V) => {
    if (n())
      return !1;
    ...
    const U = I(R), P = I(x), ee = U || P || !ss(C) || F;
    return i = !0, ee && o(y, {
      Zt: R,
      tn: x
    }), ee;
  ...
  return [() => {
    const { an: y, gt: V, Ot: H } = p, E = Fe(y), T = [m(), u(), w()], $ = H();
  ...
  if (e && !c) {
    ...
    const l = [], d = {}, p = (C) => {
      ...
      return D ? D(F, !0) : F;
    }, f = oe({}, o(), p(e)), [m, _, h] = Wn(), [w, k, M] = Wn(n), I = (C, F) => {
      M(C, F), h(C, F);
    }, [L, y, V, H, E] = Da(t, f, () => u, ({ vn: C, Dt: F }, { Zt: D, tn: R }) => {
      const { dt: x, Ct: U, xt: P, Ht: ee, Et: se, _t: ne } = D, { nn: me, sn: Y, en: S, cn: B } = R;
      I("updated", [$, {
        updateHints: {
          sizeChanged: !!x,
          directionChanged: !!U,
      ...
      La(i), Ie(l), u = !0, I("destroyed", [$, C]), _(), k();
    }, $ = {
      options(C, F) {
        if (C) {
          const D = F ? o() : {}, R = Ao(f, oe(D, p(C)));
          ss(R) || (oe(f, R), y({
            vn: R
          }));
        }
      ...
      state() {
        const { gn: C, bn: F } = V(), { F: D } = C, { Lt: R, Vt: x, k: U, rn: P, ln: ee, _n: se, Tt: ne } = F;
        return oe({}, {
          overflowEdge: R,
          overflowAmount: x,
          overflowStyle: U,
      ...
      elements() {
        const { vt: C, ht: F, ln: D, U: R, bt: x, gt: U, Qt: P } = H.wn, { Xt: ee, Gt: se } = H.yn, ne = (Y) => {
...
function Va() {
  let t;
  const e = O(null), n = Math.floor(Math.random() * 2 ** 32), o = O(!1), s = O([]), i = () => s.value, c = () => t.getSelection(), u = () => s.value.length, l = () => t.clearSelection(!0), d = O(), p = O(null), f = O(null), m = O(null), _ = O(null);
  function h() {
    t = new pr({
      area: e.value,
      keyboardDrag: !1,
  ...
  const w = () => vt(() => {
    ...
    if (!p.value)
      return;
    const { scrollOffsetElement: H } = p.value.elements();
    H.scrollTo(
      {
  ...
  return Ce(() => {
    ...
    }), h(), L(), _.value = new ResizeObserver(L), _.value.observe(e.value), e.value.addEventListener("scroll", y), t.subscribe("DS:scroll", ({ isDragging: V }) => V || y());
  }), Qn(() => {
...
const Ia = (t, e) => {
  const n = xr(t.id), o = mr(), s = n.getStore("metricUnits", !1), i = Ar(n, t.theme), c = e.i18n, u = t.locale ?? e.locale, l = (_) => Array.isArray(_) ? _ : Cr, d = n.getStore("persist-path", t.persist), p = d ? n.getStore("path", t.path) : t.path, f = d ? n.getStore("adapter") : null, m = Va();
  return St({
    /** 
    * Core properties
    * */
...
function qa(t, e, n, o, s, i) {
  return v(), g("div", {
    ...
    t.$slots.default ? Lt(t.$slots, "default", { key: 0 }) : (v(), g("span", Pa, b(o.t("Saved.")), 1))
  ], 2);
}
      ...
      default: J(() => [
        a("div", Xa, [
          ...
          a("div", Za, [
            ...
            u.value === i.SETTINGS ? (v(), g("div", ol, [
              ...
              a("div", al, [
                a("fieldset", null, [
                    ...
                    a("div", Cl, [
                      _e(a("select", {
                        ...
                        a("optgroup", {
                          ...
                          (v(!0), g(ye, null, $e(M.value, (y, V) => (v(), g("option", { value: V }, b(y), 9, Tl))), 256))
                        ], 8, El)
                      ], 544), [
                        [gs, r(e).theme.value]
                      ]),
                  ...
                  r(e).features.includes(r(ue).LANGUAGE) && Object.keys(r(k)).length > 1 ? (v(), g("div", Al, [
                    a("div", Ml, [
                    ...
                    a("div", Ol, [
                      _e(a("select", {
                        ...
                        a("optgroup", {
                          ...
                          (v(!0), g(ye, null, $e(r(k), (y, V) => (v(), g("option", { value: V }, b(y), 9, Vl))), 256))
                        ], 8, Ll)
                      ], 512), [
                        [gs, r(e).i18n.locale]
                      ]),
            ...
            u.value === i.SHORTCUTS ? (v(), g("div", Fl, [
              a("div", Il, [
                a("div", Hl, [
        ...
        a("div", null, [
          ...
          a("div", Zl, [
            a("div", Ql, [
              ...
              a("div", ei, [
                (v(!0), g(ye, null, $e(o.value, (l) => (v(), g("p", ti, [
                  l.type === "dir" ? (v(), g("svg", ni, u[2] || (u[2] = [
                    a("path", {
                      "stroke-linecap": "round",
                      "stroke-linejoin": "round",
      ...
      default: J(() => [
        a("div", null, [
          ...
          a("div", ii, [
            a("div", ci, [
              a("p", di, [
                o.value.type === "dir" ? (v(), g("svg", ui, l[3] || (l[3] = [
                  a("path", {
                    "stroke-linecap": "round",
                    "stroke-linejoin": "round",
                    d: "M3 7v10a2 2 0 002 2h14a2 2 0 002-2V9a2 2 0 00-2-2h-6l-2-2H5a2 2 0 00-2 2z"
...
const No = { render: Ai }, Mi = { class: "vuefinder__upload-modal__content" }, Di = {
  ...
  setup(t) {
    const e = re("ServiceContainer"), { t: n } = e.i18n, o = n("uppy"), s = {
      ...
      ERROR: 3,
      DONE: 10
    }, i = O({ QUEUE_ENTRY_STATUS: s }), c = O(null), u = O(null), l = O(null), d = O(null), p = O(null), f = O(null), m = O([]), _ = O(""), h = O(!1), w = O(!1);
    let k;
    function M(D) {
      return m.value.findIndex((R) => R.id === D);
    }
    function I(D, R = null) {
      R = R ?? (D.webkitRelativePath || D.name), k.addFile({
        name: R,
        type: D.type,
        data: D,
        source: "Local"
    ...
    function H() {
      if (!h.value) {
        ...
        _.value = "", k.retryAll(), k.upload();
      }
    }
    function E() {
      k.cancelAll({ reason: "user" }), m.value.forEach((D) => {
        D.status !== s.DONE && (D.status = s.CANCELED, D.statusName = n("Canceled"));
      }), h.value = !1;
    }
    function T(D) {
      h.value || (k.removeFile(D.id, "removed-by-user"), m.value.splice(M(D.id), 1));
    }
    function $(D) {
      if (!h.value) {
        if (k.cancelAll({ reason: "user" }), D) {
          const R = [];
          m.value.forEach((x) => {
            x.status !== s.DONE && R.push(x);
          }), m.value = [], R.forEach((x) => {
    ...
    return Ce(async () => {
      k = new hr({
        ...
        onBeforeFileAdded(x, U) {
          if (U[x.id] != null) {
            const ee = M(x.id);
            m.value[ee].status === s.PENDING && (_.value = k.i18n("noDuplicates", { fileName: x.name })), m.value = m.value.filter((se) => se.id !== x.id);
          }
          return m.value.push({
            id: x.id,
            name: x.name,
      ...
      }), k.on("restriction-failed", (x, U) => {
        const P = m.value[M(x.id)];
        T(P), _.value = U.message;
      }), k.on("upload", () => {
        const x = F();
        k.setMeta({ ...x.body });
        const U = k.getPlugin("XHRUpload");
        U.opts.method = x.method, U.opts.endpoint = x.url + "?" + new URLSearchParams(x.params), U.opts.headers = x.headers, delete x.headers["Content-Type"], h.value = !0, m.value.forEach((P) => {
          P.status !== s.DONE && (P.percent = null, P.status = s.UPLOADING, P.statusName = n("Pending upload"));
        });
      }), k.on("upload-progress", (x, U) => {
        const P = Math.floor(U.bytesUploaded / U.bytesTotal * 100);
        m.value[M(x.id)].percent = `${P}%`;
      }), k.on("upload-success", (x) => {
        const U = m.value[M(x.id)];
        ...
        _.value = x.message, h.value = !1, e.emitter.emit("vf-fetch", {
          params: {
            q: "index",
            adapter: e.fs.adapter,
            path: e.fs.data.dirname
        ...
        a("div", null, [
          ...
          a("div", Mi, [
            a("div", {
              ...
              w.value ? (v(), g("div", Di, b(r(n)("Release to drop these files.")), 1)) : (v(), g("div", Oi, b(r(n)("Drag and drop the files/folders to here or click here.")), 1))
            ], 512),
            a("div", {
              ref_key: "container",
              ref: c,
            ...
            a("div", Fi, [
              (v(!0), g(ye, null, $e(m.value, (x) => (v(), g("div", {
                class: "vuefinder__upload-modal__file-entry",
                key: x.id
              }, [
                a("span", {
                  class: le(["vuefinder__upload-modal__file-icon", L(x)])
                }, [
                  a("span", {
                ...
                a("div", Hi, [
                  a("div", Ri, b(r(Xn)(x.name, 40)) + " (" + b(x.size) + ") ", 1),
                  a("div", Bi, b(r(Xn)(x.name, 16)) + " (" + b(x.size) + ") ", 1),
                  a("div", {
                    class: le(["vuefinder__upload-modal__file-status", L(x)])
                  }, [
                    Z(b(x.statusName) + " ", 1),
                    x.status === i.value.QUEUE_ENTRY_STATUS.UPLOADING ? (v(), g("b", Ui, b(x.percent), 1)) : N("", !0)
                  ], 2)
                ]),
                a("button", {
                  type: "button",
              ...
              m.value.length ? N("", !0) : (v(), g("div", Pi, b(r(n)("No files selected!")), 1))
            ]),
            _.value.length ? (v(), K(Ze, {
              key: 0,
              onHidden: R[2] || (R[2] = (x) => _.value = ""),
              error: ""
            }, {
              default: J(() => [
                Z(b(_.value), 1)
    ...
    return (u, l) => (v(), K(Xe, null, {
      ...
      default: J(() => [
        a("div", null, [
          ...
          a("div", Wi, [
            a("div", Ki, [
              (v(!0), g(ye, null, $e(i.value, (d) => (v(), g("p", Yi, [
                d.type === "dir" ? (v(), g("svg", Xi, l[2] || (l[2] = [
                  a("path", {
                    "stroke-linecap": "round",
                    "stroke-linejoin": "round",
                    d: "M3 7v10a2 2 0 002 2h14a2 2 0 002-2V9a2 2 0 00-2-2h-6l-2-2H5a2 2 0 00-2 2z"
      ...
      default: J(() => [
        a("div", null, [
          ...
          a("div", nc, [
            a("div", sc, [
              a("div", oc, [
                (v(!0), g(ye, null, $e(i.value, (d) => (v(), g("p", rc, [
                  d.type === "dir" ? (v(), g("svg", ac, l[3] || (l[3] = [
                    a("path", {
                      "stroke-linecap": "round",
                      "stroke-linejoin": "round",
                      d: "M3 7v10a2 2 0 002 2h14a2 2 0 002-2V9a2 2 0 00-2-2h-6l-2-2H5a2 2 0 00-2 2z"
...
const xc = { render: kc }, Sc = { class: "vuefinder__toolbar" }, $c = {
  ...
  setup(t) {
    ...
    return (l, d) => (v(), g("div", Sc, [
      i.value.length ? (v(), g("div", Lc, [
        a("div", Vc, [
        ...
        r(e).features.includes(r(ue).NEW_FOLDER) ? (v(), g("div", {
          ...
          class: "mx-1.5",
          title: r(o)("New Folder"),
          onClick: d[0] || (d[0] = (p) => r(e).modal.open(Bo, { items: r(s).getSelected() }))
        }, [
          j(r(Ro))
        ], 8, Cc)) : N("", !0),
        r(e).features.includes(r(ue).NEW_FILE) ? (v(), g("div", {
          ...
          class: "mx-1.5",
          title: r(o)("New File"),
          onClick: d[1] || (d[1] = (p) => r(e).modal.open(Ei, { items: r(s).getSelected() }))
        }, [
          j(r(Uo))
        ], 8, Ec)) : N("", !0),
        r(e).features.includes(r(ue).RENAME) ? (v(), g("div", {
          ...
          class: "mx-1.5",
          title: r(o)("Rename"),
          onClick: d[2] || (d[2] = (p) => r(s).getCount() !== 1 || r(e).modal.open(vs, { items: r(s).getSelected() }))
        }, [
          j(r(Ho), {
        ...
        r(e).features.includes(r(ue).DELETE) ? (v(), g("div", {
          ...
          class: "mx-1.5",
          title: r(o)("Delete"),
          onClick: d[3] || (d[3] = (p) => !r(s).getCount() || r(e).modal.open(fs, { items: r(s).getSelected() }))
        }, [
          j(r(Io), {
        ...
        r(e).features.includes(r(ue).UPLOAD) ? (v(), g("div", {
          ...
          class: "mx-1.5",
          title: r(o)("Upload"),
          onClick: d[4] || (d[4] = (p) => r(e).modal.open(zi, { items: r(s).getSelected() }))
        }, [
          j(r(No))
        ], 8, Mc)) : N("", !0),
        r(e).features.includes(r(ue).UNARCHIVE) && r(s).getCount() === 1 && r(s).getSelected()[0].mime_type === "application/zip" ? (v(), g("div", {
          ...
          class: "mx-1.5",
          title: r(o)("Unarchive"),
          onClick: d[5] || (d[5] = (p) => !r(s).getCount() || r(e).modal.open(qo, { items: r(s).getSelected() }))
        }, [
          j(r(Po), {
            class: le(r(s).getCount() ? "vf-toolbar-icon" : "vf-toolbar-icon-disabled")
          }, null, 8, ["class"])
        ...
        r(e).features.includes(r(ue).ARCHIVE) ? (v(), g("div", {
          ...
          class: "mx-1.5",
          title: r(o)("Archive"),
          onClick: d[6] || (d[6] = (p) => !r(s).getCount() || r(e).modal.open(jo, { items: r(s).getSelected() }))
        }, [
          j(r(zo), {
            class: le(r(s).getCount() ? "vf-toolbar-icon" : "vf-toolbar-icon-disabled")
          }, null, 8, ["class"])
      ...
      a("div", Ic, [
        r(e).features.includes(r(ue).FULL_SCREEN) ? (v(), g("div", {
          ...
          r(e).fullScreen ? (v(), K(r(hc), { key: 0 })) : (v(), K(r(_c), { key: 1 }))
        ], 8, Hc)) : N("", !0),
        a("div", {
          class: "mx-1.5",
          title: r(o)("Change View"),
          onClick: d[7] || (d[7] = (p) => i.value.length || u())
        }, [
          r(e).view === "grid" ? (v(), K(r(wc), {
            key: 0,
            class: le(["vf-toolbar-icon", i.value.length ? "vf-toolbar-icon-disabled" : ""])
          }, null, 8, ["class"])) : N("", !0),
          r(e).view === "list" ? (v(), K(r(xc), {
            key: 1,
            class: le(["vf-toolbar-icon", i.value.length ? "vf-toolbar-icon-disabled" : ""])
          }, null, 8, ["class"])) : N("", !0)
        ], 8, Rc)
      ...
      default: J(() => [
        a("div", null, [
          ...
          a("div", zc, [
            ...
            a("div", Gc, [
              (v(!0), g(ye, null, $e(o.value, (l) => (v(), g("div", Wc, [
                a("div", null, [
                  l.type === "dir" ? (v(), g("svg", Kc, u[2] || (u[2] = [
                    a("path", {
                      "stroke-linecap": "round",
                      "stroke-linejoin": "round",
                      d: "M3 7v10a2 2 0 002 2h14a2 2 0 002-2V9a2 2 0 00-2-2h-6l-2-2H5a2 2 0 00-2 2z"
...
const xd = { render: kd }, Sd = { class: "vuefinder__breadcrumb__container" }, $d = ["title"], Cd = ["title"], Ed = ["title"], Td = { class: "vuefinder__breadcrumb__list" }, Ad = {
  ...
  setup(t) {
    ...
    return (E, T) => (v(), g("div", Sd, [
      ...
      _e(a("div", {
        ...
        a("div", Td, [
          r(e).fs.hiddenBreadcrumbs.length ? _e((v(), g("div", Ad, [
        ...
        a("div", {
          ...
          (v(!0), g(ye, null, $e(r(e).fs.breadcrumbs, ($, C) => (v(), g("div", { key: C }, [
            ...
            a("span", {
              ...
              onDrop: (F) => C === r(e).fs.breadcrumbs.length - 1 || p(F, C),
  ...
  setup(t) {
    const e = re("ServiceContainer"), { getStore: n } = e.storage, o = O(n("full-screen", !1)), s = O([]), i = (l) => l === "error" ? "text-red-400 border-red-400 dark:text-red-300 dark:border-red-300" : "text-lime-600 border-lime-600 dark:text-lime-300 dark:border-lime-1300", c = (l) => {
      ...
      let d = s.value.findIndex((p) => p.id === l);
      d !== -1 && c(d);
    };
    return e.emitter.on("vf-toast-clear", () => {
      ...
      j(dr, {
        ...
        default: J(() => [
          (v(!0), g(ye, null, $e(s.value, (p, f) => (v(), g("div", {
            key: f,
            onClick: (m) => c(f),
            class: le(["vuefinder__toast__message", i(p.type)])
          }, b(p.label), 11, Bd))), 128))
        ]),
        _: 1
      })
...
const Gd = { render: jd }, Jt = {
  ...
  setup(t) {
    return (e, n) => (v(), g("div", null, [
      t.direction === "asc" ? (v(), K(r(qd), { key: 0 })) : N("", !0),
      t.direction === "desc" ? (v(), K(r(Gd), { key: 1 })) : N("", !0)
    ]));
  }
}, Wd = {
  xmlns: "http://www.w3.org/2000/svg",
...
const Jd = { render: Qd }, eu = { class: "vuefinder__drag-item__container" }, tu = { class: "vuefinder__drag-item__count" }, nu = {
  ...
  emits: ["success"],
  setup(t, { emit: e }) {
    const n = e, o = O(""), s = O(""), i = O(null), c = O(!1), u = O(""), l = O(!1), d = re("ServiceContainer"), { t: p } = d.i18n;
    Ce(() => {
      d.requester.send({
        url: "",
        method: "get",
    ...
    const f = () => {
      ...
      u.value = "", l.value = !1, d.requester.send({
        ...
        u.value = p("Updated."), o.value = _, n("success"), c.value = !c.value;
      }).catch((_) => {
        u.value = p(_.message), l.value = !0;
      });
    };
    return (_, h) => (v(), g("div", su, [
      a("div", ou, [
        a("div", {
        ...
        a("div", au, [
          ...
          r(d).features.includes(r(ue).EDIT) ? (v(), g("button", {
            ...
            onClick: h[0] || (h[0] = (w) => f())
          }, b(c.value ? r(p)("Cancel") : r(p)("Edit")), 1)) : N("", !0)
        ])
      ]),
      a("div", null, [
        c.value ? (v(), g("div", iu, [
        ...
        ])) : (v(), g("pre", lu, b(o.value), 1)),
        u.value.length ? (v(), K(Ze, {
          key: 2,
  ...
  emits: ["success"],
  setup(t, { emit: e }) {
    const n = e, o = re("ServiceContainer"), { t: s } = o.i18n, i = O(null), c = O(null), u = O(!1), l = O(""), d = O(!1), p = () => {
      ...
      c.value.getCroppedCanvas({
        ...
        (m) => {
          ...
          _.set("file", m), o.requester.send({
            ...
            l.value = s("Updated."), i.value.src = o.requester.getPreviewUrl(o.modal.data.adapter, o.modal.data.item), p(), n("success");
          }).catch((h) => {
  ...
  setup(t) {
    ...
    return i || (o.value = !0), (c, u) => (v(), K(Xe, null, {
      buttons: J(() => [
        a("button", {
          type: "button",
      ...
      default: J(() => [
        ...
        r(e).features.includes(r(ue).DOWNLOAD) ? (v(), g("div", qu, [
...
const Ko = { render: Gu }, Wu = ["data-type", "data-item", "data-index"], Fn = {
  ...
  setup(t) {
    const e = re("ServiceContainer"), n = e.dragSelect, o = t, s = (_) => {
      _.type === "dir" ? (e.emitter.emit("vf-search-exit"), e.emitter.emit("vf-fetch", { params: { q: "index", adapter: e.fs.adapter, path: _.path } })) : e.modal.open(Wo, { adapter: e.fs.adapter, item: _ });
    }, i = {
      mounted(_, h, w, k) {
        w.props.draggable && (_.addEventListener("dragstart", (M) => c(M, h.value)), _.addEventListener("dragover", (M) => l(M, h.value)), _.addEventListener("drop", (M) => u(M, h.value)));
      },
      beforeUnmount(_, h, w, k) {
        w.props.draggable && (_.removeEventListener("dragstart", c), _.removeEventListener("dragover", l), _.removeEventListener("drop", u));
      }
    }, c = (_, h) => {
      ...
      if (w.find((k) => k.storage !== e.fs.adapter)) {
        alert("Moving items between different storages is not supported yet.");
        return;
      }
    ...
    const f = () => {
      ...
      if (!p)
        ...
        return p = !1, s(o.item), clearTimeout(d), !1;
      d = setTimeout(() => {
    ...
    return (_, h) => _e((v(), g("div", {
      style: fn({ opacity: r(n).isDraggingRef.value && r(n).getSelection().find((w) => _.$el === w) ? "0.5 !important" : "" }),
  ...
  setup(t) {
    ...
    const l = St({ active: !1, column: "", order: "" }), d = (f = !0) => {
      ...
      if (!f)
        return m;
      const w = (k, M) => typeof k == "string" && typeof M == "string" ? k.toLowerCase().localeCompare(M.toLowerCase()) : k < M ? -1 : k > M ? 1 : 0;
      return l.active && (m = m.slice().sort((k, M) => w(k[_], M[_]) * h)), m;
    }, p = (f) => {
    ...
    return Ce(() => {
      ...
      r(e).view === "list" || i.value.length ? (v(), g("div", Yu, [
        a("div", {
      ...
      a("div", {
        ...
        onContextmenu: m[4] || (m[4] = tt((_) => r(e).emitter.emit("vf-contextmenu-show", { event: _, items: r(c).getSelected() }), ["self", "prevent"]))
      }, [
        r(e).loadingIndicator === "linear" && r(e).fs.loading ? (v(), g("div", Zu)) : N("", !0),
        i.value.length ? (v(!0), g(ye, { key: 1 }, $e(d(), (_, h) => (v(), K(Fn, {
          item: _,
          index: h,
          dragImage: s.value,
        ...
        r(e).view === "list" && !i.value.length ? (v(!0), g(ye, { key: 2 }, $e(d(), (_, h) => (v(), K(Fn, {
          item: _,
          index: h,
          dragImage: s.value,
          class: "vf-item vf-item-list",
          ...
          default: J(() => [
            a("div", nf, [
              a("div", sf, [
                ...
                a("span", of, b(_.basename), 1)
              ]),
              a("div", rf, b(_.file_size ? r(e).filesize(_.file_size) : ""), 1),
              a("div", af, b(r(Go)(_.last_modified)), 1)
            ])
          ]),
          _: 2
        }, 1032, ["item", "index", "dragImage"]))), 128)) : N("", !0),
        r(e).view === "grid" && !i.value.length ? (v(!0), g(ye, { key: 3 }, $e(d(!1), (_, h) => (v(), K(Fn, {
          item: _,
          index: h,
          dragImage: s.value,
          ...
          default: J(() => [
            a("div", null, [
              a("div", lf, [
                (_.mime_type ?? "").startsWith("image") && r(e).showThumbnails ? (v(), g("img", {
                ...
                !((_.mime_type ?? "").startsWith("image") && r(e).showThumbnails) && _.type !== "dir" ? (v(), g("div", df, b(o(_.extension)), 1)) : N("", !0)
              ]),
              a("span", uf, b(r(Xn)(_.basename)), 1)
            ])
          ]),
          _: 2
        }, 1032, ["item", "index", "dragImage"]))), 256)) : N("", !0)
  ...
  setup(t) {
    ...
    e.emitter.on("vf-search-query", ({ newQuery: d }) => {
      s.value = d;
    }), e.emitter.on("vf-contextmenu-show", ({ event: d, items: p, target: f = null }) => {
      if (i.items = e.contextMenuItems.filter((m) => m.show(e, {
        ...
        if (f)
          ...
          return;
      else !f && !s.value ? e.emitter.emit("vf-context-selected", []) : p.length > 1 && p.some((m) => m.path === f.path) ? e.emitter.emit("vf-context-selected", p) : e.emitter.emit("vf-context-selected", [f]);
      l(d);
    }), e.emitter.on("vf-contextmenu-hide", () => {
      i.active = !1;
    });
    const l = (d) => {
      const p = e.dragSelect.area.value, f = e.root.getBoundingClientRect(), m = p.getBoundingClientRect();
      let _ = d.clientX - f.left, h = d.clientY - f.top;
      i.active = !0, vt(() => {
        var I;
        const w = (I = n.value) == null ? void 0 : I.getBoundingClientRect();
        let k = (w == null ? void 0 : w.height) ?? 0, M = (w == null ? void 0 : w.width) ?? 0;
        _ = m.right - d.pageX + window.scrollX < M ? _ - M : _, h = m.bottom - d.pageY + window.scrollY < k ? h - k : h, i.positions = {
          left: _ + "px",
          top: h + "px"
        };
      });
    };
    return (d, p) => _e((v(), g("ul", {
      ref_key: "contextmenu",
      ref: n,
      ...
      (v(!0), g(ye, null, $e(i.items, (f) => (v(), g("li", {
        ...
        f.link ? (v(), g("a", {
          ...
          href: c(f),
          download: c(f),
          onClick: p[0] || (p[0] = (m) => r(e).emitter.emit("vf-contextmenu-hide"))
        }, [
...
const wf = { render: bf }, yf = { class: "vuefinder__status-bar__wrapper" }, kf = { class: "vuefinder__status-bar__space" }, xf = { class: "vuefinder__status-bar__space-container" }, Sf = { class: "vuefinder__status-bar__space-icon" }, $f = { class: "vuefinder__status-bar__space-text" }, Cf = { class: "vuefinder__status-bar__actions" }, Ef = ["disabled"], Tf = ["title"], Af = {
  ...
  setup(t) {
    ...
    const c = ze(() => {
      const f = e.selectButton.multiple ? s.getSelected().length > 0 : s.getSelected().length === 1;
      return e.selectButton.active && f;
    }), u = ze(() => {
      var m, _;
      const f = (_ = (m = e.fs) == null ? void 0 : m.data) == null ? void 0 : _.used_space;
      return typeof f == "number" ? f.toFixed(2) : "0.00";
    }), l = ze(() => {
      var m, _;
      const f = (_ = (m = e.fs) == null ? void 0 : m.data) == null ? void 0 : _.total_space;
      return typeof f == "number" ? f.toFixed(2) : "0.00";
    }), d = ze(() => {
      var _, h, w, k;
      const f = (h = (_ = e.fs) == null ? void 0 : _.data) == null ? void 0 : h.used_space, m = (k = (w = e.fs) == null ? void 0 : w.data) == null ? void 0 : k.total_space;
      return typeof f == "number" && typeof m == "number" && m !== 0 ? (f / m * 100).toFixed(2) : "0.00";
    }), p = ze(() => `Used ${u.value}Mb out of ${l.value}Mb (${d.value}%)`);
    return (f, m) => (v(), g("div", yf, [
      a("div", kf, [
        a("div", xf, [
          a("span", Sf, [
            j(r(Yo))
          ]),
          a("span", $f, b(p.value), 1)
        ])
      ]),
      a("div", Cf, [
        r(e).selectButton.active ? (v(), g("button", {
          ...
          disabled: !c.value,
          onClick: m[0] || (m[0] = (_) => r(e).selectButton.click(r(s).getSelected(), _))
        }, b(r(n)("Select")), 11, Ef)) : N("", !0),
        a("span", {
          class: "vuefinder__status-bar__about",
          title: r(n)("About"),
          onClick: m[1] || (m[1] = (_) => r(e).modal.open(Fo))
        }, [
          j(r(wf))
        ], 8, Tf)
      ])
...
const Bf = { class: "vuefinder__folder-loader-indicator" }, Uf = {
    ...
    return (l, d) => {
      ...
      return v(), g("div", Bf, [
        i.value ? (v(), K(r(_s), {
          ...
          s.value && ((p = c()) != null && p.folders.length) ? (v(), K(r(Qo), {
            key: 0,
            class: "vuefinder__folder-loader-indicator--minus"
          })) : N("", !0),
          s.value ? N("", !0) : (v(), K(r(Zo), {
            key: 1,
  ...
  setup(t) {
    ...
    return (c, u) => {
      ...
      return v(), g("ul", {
        ...
        (v(!0), g(ye, null, $e(i.value, (d, p) => (v(), g("li", {
          key: d.path,
          ...
          a("div", Nf, [
            ...
            a("div", {
              ...
              a("div", zf, [
                r(e).fs.path === d.path ? (v(), K(r(Xo), { key: 0 })) : (v(), K(r(kn), { key: 1 }))
              ]),
              a("div", {
  ...
  setup(t) {
    ...
    return (n, o) => (v(), g("div", Kf, [
      a("div", Yf, [
        e.value ? (v(), K(r(Qo), {
          key: 0,
          class: "vuefinder__folder-indicator--minus"
        })) : N("", !0),
        e.value ? N("", !0) : (v(), K(r(Zo), {
          key: 1,
  ...
  setup(t) {
    ...
    Oe(c, (p) => s("pinned-folders-opened", p));
    const u = (p) => {
      e.pinnedFolders = e.pinnedFolders.filter((f) => f.path !== p.path), e.storage.setStore("pinned-folders", e.pinnedFolders);
    }, l = (p) => {
      const f = p.clientX, m = p.target.parentElement, _ = m.getBoundingClientRect().width;
      m.classList.remove("transition-[width]"), m.classList.add("transition-none");
      const h = (k) => {
        i.value = _ + k.clientX - f, i.value < 50 && (i.value = 0, e.showTreeView = !1), i.value > 50 && (e.showTreeView = !0);
      }, w = () => {
        const k = m.getBoundingClientRect();
        i.value = k.width, m.classList.add("transition-[width]"), m.classList.remove("transition-none"), window.removeEventListener("mousemove", h), window.removeEventListener("mouseup", w);
      };
    ...
    return Ce(() => {
      ...
      Jo(e.treeViewData, { path: e.fs.path, folders: m.map((_) => ({
        adapter: _.storage,
        path: _.path,
        basename: _.basename
      })) });
      ...
      a("div", {
        ...
        a("div", {
          ...
          a("div", Zf, [
            ...
            c.value ? (v(), g("ul", ev, [
              (v(!0), g(ye, null, $e(r(e).pinnedFolders, (m) => (v(), g("li", tv, [
                a("div", {
                  class: "vuefinder__treeview__pinned-folder",
                  onClick: (_) => r(e).emitter.emit("vf-fetch", { params: { q: "index", adapter: m.storage, path: m.path } })
                }, [
                  r(e).fs.path !== m.path ? (v(), K(r(kn), {
                    key: 0,
                    class: "vuefinder__treeview__folder-icon"
                  })) : N("", !0),
                  r(e).fs.path === m.path ? (v(), K(r(Xo), {
                    key: 1,
              ...
              r(e).pinnedFolders.length ? N("", !0) : (v(), g("li", rv, [
                a("div", av, b(r(n)("No folders pinned")), 1)
              ]))
            ])) : N("", !0)
          ]),
          (v(!0), g(ye, null, $e(r(e).fs.data.storages, (m) => (v(), g("div", lv, [
  ...
  setup(t, { emit: e }) {
    ...
    s.emitter.on("vf-fetch-abort", () => {
      ...
      ({
        ...
        s.requester.send({
          ...
          s.fs.adapter = M.adapter, s.persist && (s.fs.path = M.dirname, i("path", s.fs.path)), w || s.modal.close(), l(M), _ && _(M);
        }).catch((M) => {
    ...
    function p(f) {
      ...
      f && f.includes("://") && (m = {
        ...
        onError: o.onError ?? ((_) => {
          _.message && s.emitter.emit("vf-toast-push", {
            label: _.message,
            type: "error"
          });
        })
